This project has allowed me to learn and apply a wide range of technologies,
including frontend development with interactive maps and charts, backend development with Node.js and Express, and cloud services like AWS S3. 
It has also given me experience with handling file uploads, processing geospatial data, and implementing user interactions for data visualization. 
Overall, this project has been a great opportunity to build a full-stack application that combines multiple technologies to create a useful tool for runners to analyze their routes and performance.
